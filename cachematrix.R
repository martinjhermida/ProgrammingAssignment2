## These functions create a matrix and its inverse. The fist function
## creates a matrix and formulas to access it and its inverse from cache.
## The second function calculates and caches the inverse.

## makeCacheMatrix caches a matrix specified in the argument of the
##function. It also allows to call formulas with $ to change the matrix or
